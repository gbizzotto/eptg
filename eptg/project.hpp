...
public:
	...
	Project execute(const eptg::CopyMoveData<STR> & copy_move_data)
	{
        ...
        Project dest_project(eptg::str::to<STR>(copy_move_data.dest), eptg::str::to<STR>(is_same_project?L"":read_file(path::append(copy_move_data.dest, PROJECT_FILE_NAME))));
